...
from .views import (PayrollCenterCreate, PayrollCenterUpdate, PayrollCenterListView, PayrollCenterDetailView,
                    ...
                    PayrollPeriodForProcessing, LSTListView, PayrollPeriodCloseListView,
...
urlpatterns = [
    ...
    path('currencys/add/', CurrencyCreate.as_view(), name='currency-create'),
    path('currency<int:pk>/edit/', CurrencyUpdate.as_view(), name='currency-update'),
    path('currencys/', CurrencyListView.as_view(), name='currency-list'),
