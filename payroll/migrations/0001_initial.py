    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='support_data.Organization')),
            ],
        ),
        migrations.CreateModel(
            name='PayrollPeriod',
            fields=[
                ...
                ('payroll_key', models.CharField(max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=150)),
                ('recurrent', models.CharField(choices=[('1', 'Yes'), ('0', 'No')], max_length=3)),
                ('taxable', models.CharField(choices=[('1', 'Yes'), ('0', 'No')], max_length=3)),
                ('ed_category', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='payroll.EarningDeductionCategory')),
            ],
        ),
    ]
