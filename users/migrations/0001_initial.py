    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employment_status', models.CharField(blank=True,
                                                       choices=[('RECRUIT', 'Recruit'), ('APPROVED', 'Approved'),
                                                                ('REJECTED', 'Rejected'), ('TERMINATED', 'Terminated')],
                                                       default='RECRUIT', max_length=17)),
                ('bank_1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING,
                                             related_name='first_bank', to='payroll.Bank')),
                ('bank_2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING,
                ...
                ('currency', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING,
                                               to='payroll.Currency')),
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING,
                ...
                ('grade', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING,
                                            to='support_data.Grade')),
                ('job_title', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payroll_key',
                 models.CharField(blank=True, default=None, max_length=150, primary_key=True, serialize=False,
                                  unique=True)),
