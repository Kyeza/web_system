    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kin_date_of_birth', models.DateField(blank=True, null=True, verbose_name='Date of birth')),
                ('kin_address', models.CharField(blank=True, max_length=250, null=True, verbose_name='Address')),
                ('dr_ac_code', models.CharField(blank=True, max_length=50, null=True, verbose_name='DR A/C code')),
                ('cr_ac_code', models.CharField(blank=True, max_length=50, null=True, verbose_name='CR A/C code')),
                ...
                ('kin_nationality', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='support_data.Nationality', verbose_name='Nationality')),
